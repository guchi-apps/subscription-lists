...
export function AppVersionInfo({
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-sm font-semibold text-muted-foreground">バージョン</h2>
      <Dialog>
        <DialogTrigger asChild>
          <button type="button" className="text-sm text-foreground underline-offset-4 hover:underline">
            バージョン {version}
          </button>
        </DialogTrigger>
